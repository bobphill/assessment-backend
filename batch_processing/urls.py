...
from batch_processing.views import Upload_Batch_File, Upload_Batch_Body, RetrieveObject, RetrieveObjectArray
...
urlpatterns = [
    ...
    path('object_list/', RetrieveObjectArray.as_view(), name="object_list"),
